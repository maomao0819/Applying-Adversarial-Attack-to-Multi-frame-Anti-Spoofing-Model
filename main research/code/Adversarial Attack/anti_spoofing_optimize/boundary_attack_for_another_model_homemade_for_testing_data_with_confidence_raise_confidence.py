...
def boundary_attack():
    ...
    path_save = "adversarial_example_boundary_attack_for_testing_data_test_100_124_confidence_0.8"
        ...
        if os.path.isdir(os.path.join(path_read_attack_image, dname)):
            ...
            if int(dname_list[2]) > 100:
                ...
                for img_name in os.listdir(os.path.join(path_read_attack_image, dname)):
                    ...
                    confidence = 0.8
                    attack_class = (model.predict(initial_sample) > confidence)[0][0].astype("int32")
                    ...
                    while True:
                        ...
                        n_calls += 1
                        if (prediction > confidence)[0][0].astype("int32") == attack_class:
                    ...
                    while True:
                        ...
                        while True:
                            ...
                            n_calls += 10
                            predictions = (predictions > confidence).astype("int32")
                        ...
                        if n_steps >= step_limit:
                            ...
                            if (model.predict(moveaxis_change_channel_order(adversarial_sample)) > confidence)[0][0].astype("int32") == attack_class:
