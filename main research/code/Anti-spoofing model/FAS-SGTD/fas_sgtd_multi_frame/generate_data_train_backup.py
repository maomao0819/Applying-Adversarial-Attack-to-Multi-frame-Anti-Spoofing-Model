...
def exists_face_image(path_image,name_pure,suffix2,rangevar):
    ...
    for i in rangevar:
        ...
        face_name_full=os.path.join(path_image, name_pure, str(i) + '_' + suffix2_2)
...
def read_data_decode(name_pure, path_image, path_scene, start_ind, end_ind, label, face_name_full):
    ...
    scene_name_full = os.path.join(path_scene, name_pure, str(start_ind) + suffix4)
    ...
    for i in range(start_ind, end_ind+1, interval_seq):
        ...
        if os.path.exists(os.path.join(path_image, name_pure, str(i) + '_' + suffix2_2)) == False:
            break
