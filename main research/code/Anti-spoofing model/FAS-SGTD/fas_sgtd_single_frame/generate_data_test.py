...
def get_res_list(res_list):
    ...
    each_len = int(len_list/6) if int(len_list/6) >= 1 else 1
    res_list_new = []
...
def input_fn_generator(train_list, shuffle):
    ...
    for i in range(len(FILES_LIST)):
        ...
        # if dataset == 'OULU-NPU':
        #     folder_lack_image = ['2_3_40_2', '6_3_39_5', '6_3_40_4', '6_3_38_5']
        #     if name_pure in folder_lack_image:
        #         continue
        # elif dataset == 'CASIA-FASD':
        #     folder_lack_image = ['2', '8', '28']
        #     if path_image.split('/')[-2] in folder_lack_image:
        #         continue
