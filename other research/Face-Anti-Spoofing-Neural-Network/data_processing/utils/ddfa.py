...
def reconstruct_vertex(param, whitening=True, dense=False, transform=True):
    ...
    if whitening:
        if len(param) == 62:
            ...
            # print('param_std shape', np.shape(param_std))
            # print('param_mean', param_mean)
            # print('param_mean shape', np.shape(param_mean))
            # param = param * param_std + param_mean
            param = param * np.std(param) + np.mean(param_mean)
    ...
    # print(w_shp)
    # print('w_shp shape', np.shape(w_shp))
    # print(alpha_shp)
    # print('alpha_shp shape', np.shape(alpha_shp))
    # print(w_exp)
    # print('w_exp shape', np.shape(w_exp))
    # print(alpha_exp)
    alpha_exp = alpha_exp[:10]
    # print('alpha_exp shape', np.shape(alpha_exp))
    # print(offset)
    # print('offset shape', np.shape(offset))
    if dense:
