...
def create_adversarial_pattern(input_image, input_label, model):
    ...
    with tf.GradientTape() as tape:
        ...
        # img_aug_list = []
        # for _ in range(1999):
        #     img_aug_list.append((image_augment(input_image * float(255)) / float(255))[0])
        # print("shape2", np.shape(img_aug_list))
        # prediction = model(img_aug_list)
        # print("prediction", prediction)
        loss /= 600
        # print('loss2 ', loss)
...
if __name__ == "__main__":
    ...
    path_save = "adversarial_example_ifgsm_range_for_testing_data_with_imgaug_with_PSNR_test_100_124"
