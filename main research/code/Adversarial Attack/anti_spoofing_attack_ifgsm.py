...
def anti_spoofying_attack(name_list, data_dir, dirs, img_width, img_height, model, epsilons):
    ...
    path_save = "adversarial_example_ifgsm/"
...
if __name__ == "__main__":
    ...
    if os.path.exists("adversarial_example_ifgsm/attack success rate.txt"):
        os.remove("adversarial_example_ifgsm/attack success rate.txt")
