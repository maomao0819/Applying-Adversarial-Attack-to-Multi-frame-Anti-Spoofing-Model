...
path_gen_save = './model_multipler_2_inverse'
...
flags.path.single_frame_model = os.path.join('model_single_frame_multipler_2_inverse', flags.path.dataset)
flags.name=edict()
...
if flags.path.dataset == 'OULU-NPU':
    ...
    flags.path.model = path_gen_save 
...
#                             3: >= 0.5
#                             4: > 0.5
flags.paras.logit_type = 'paper'    # 'paper' or 'normal'
