...
if __name__ == '__main__':
        ...
        for session in range(1,3):
            for user in range(1,6):
                for file in range(1,3):
                    ...
                    if user<10:
                        nom = '0'+nom
                    cap = cv2.VideoCapture('/mnt/sda1/mike/OULU-NPU/Train_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'.avi')

                    lines = []
                    with open('/mnt/sda1/mike/OULU-NPU/Train_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'.txt', 'r') as f:
                        for i in range(5):
                    ...
                    while(currentFrame<5):
                        ...
                        name = '/mnt/sda1/mike/OULU-NPU/Train_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'_'+str(currentFrame)+'.png'
    ...
    for phone in range(1,3):
        for session in range(1,3):
            for user in range(21,26):
                for file in range(1,3):
                    nom= str(user)
                    if user<10:
                        nom = '0'+nom
                    cap = cv2.VideoCapture('/mnt/sda1/mike/OULU-NPU/Dev_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'.avi')

                    lines = []
                    with open('/mnt/sda1/mike/OULU-NPU/Dev_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'.txt', 'r') as f:
                        for i in range(5):
                            lines.append(f.readline())
    ...
    for phone in range(1,3):
        for session in range(1,3):
            for user in range(36,41):
                for file in range(1,3):
                    nom= str(user)
                    if user<10:
                        nom = '0'+nom
                    cap = cv2.VideoCapture('/mnt/sda1/mike/OULU-NPU//Test_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'.avi')

                    lines = []
                    with open('/mnt/sda1/mike/OULU-NPU/Test_files/'+str(phone)+'_'+str(session)+'_'+nom+'_'+str(file)+'.txt', 'r') as f:
                        for i in range(5):
                            lines.append(f.readline())
