...
class Casia:
    ...
    def isInPotocol(self, file_name_full):
        ...
        if file_name == '1' or file_name == '2'  or file_name == 'HR_1' :
            return False
        else:
            return True
...
class MSU_MFSD:
    ...
    def isInPotocol(self, file_name_full):
        ...
        if file_name_list[0] == 'real':
            return False
        file_name = file_name_list[1]
        train = ['02', '03', '05', '06', '07', '08', '09', '11', '12', '21', '22', '34', '53', '54', '55']
        test = ['01', '13', '14', '23', '24', '26', '28', '29', '30', '32', '33', '35', '36', '37', '39', '42', '48', '49', '50', '51']
        name_split = file_name.replace('client0', '')
        if self.mode == 'train':
            if name_split in train:
                return True
        if self.mode == 'test':
            if name_split in test:
                return True
        return False
...
def preprocess_for_train(images):
    ...
    args={}
    args['saturation'] = tf.random.uniform([], 0.5, 1.5, dtype=tf.float32)
    args['hue'] = tf.random.uniform([], -0.2, 0.2, dtype=tf.float32)
    args['contrast'] = tf.random.uniform([], 0.5, 1.5, dtype=tf.float32)
    args['brightness'] = tf.random.uniform([], -32. / 255., 32. / 255., dtype=tf.float32)
    ##
